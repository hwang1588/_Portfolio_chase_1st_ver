...
$(function () {
  ...
  $(".orange_circle").mouseenter(function () { //"orange_circle"요소에 '마우스가진입'하면
    ...
    $(".1Q").click(function () { //"switch"요소를 '클릭'했을때
    if ($(this).hasClass("active")) { //'만약에' "switch"(this)요소에 "on"요소가 '있을경우'
      ...
      //"switch"(this)요소에 "off"요소를 '추가'하고 "on"요소를 '제거'함
    } 
  });
  
  $(".2Q").click(function () { //"switch"요소를 '클릭'했을때
    if ($(this).hasClass("active")) { //'만약에' "switch"(this)요소에 "on"요소가 '있을경우'
      $(".R-2Q").addClass("d-block").removeClass("d-none");
      $(".R-1Q").addClass("d-none").removeClass("d-block");
      $(".R-3Q").addClass("d-none").removeClass("d-block");
      $(".R-4Q").addClass("d-none").removeClass("d-block");//"switch"(this)요소에 "off"요소를 '추가'하고 "on"요소를 '제거'함
    } 
  });
  
  $(".3Q").click(function () { //"switch"요소를 '클릭'했을때
    if ($(this).hasClass("active")) { //'만약에' "switch"(this)요소에 "on"요소가 '있을경우'
  ...
  $(".4Q").click(function () { //"switch"요소를 '클릭'했을때
    if ($(this).hasClass("active")) { //'만약에' "switch"(this)요소에 "on"요소가 '있을경우'
      $(".R-4Q").addClass("d-block").removeClass("d-none");
      $(".R-1Q").addClass("d-none").removeClass("d-block");
      $(".R-2Q").addClass("d-none").removeClass("d-block");
      $(".R-3Q").addClass("d-none").removeClass("d-block");//"switch"(this)요소에 "off"요소를 '추가'하고 "on"요소를 '제거'함
    } 
  });
